...
- [ ] **P1 / S** Make layout selection explicit on the document — `LayoutSource::Template | LayoutSource::User` enum. Today `MindMapScene::setTemplateId` (lines 156-167) silently rewrites layout style as a hidden side effect.
