...
const platforms = [
    {
        ...
        icon: (
            <svg
                ...
                clipRule="evenodd"
            >
                <path d="M12 2.5c-2.9 0-4.4 2.2-4.1 5.4.1 1.2-.1 2.1-.7 3.1-.4.7-.9 1.4-1.4 2.2-1.1 1.7-1.9 3.5-1.7 5.3.2 1.4 1.1 2.5 2.5 2.6.6.1 1.3 0 1.9-.3.5 1 1.6 1.7 2.9 1.9.6.1 1.2.1 1.6.1.4 0 1 0 1.6-.1 1.3-.2 2.4-.9 2.9-1.9.6.3 1.3.4 1.9.3 1.4-.1 2.3-1.2 2.5-2.6.2-1.8-.6-3.6-1.7-5.3-.5-.8-1-1.5-1.4-2.2-.6-1-.8-1.9-.7-3.1.3-3.2-1.2-5.4-4.1-5.4zm-1.7 5.1c.7 0 1.2.7 1.2 1.6s-.5 1.6-1.2 1.6-1.2-.7-1.2-1.6.5-1.6 1.2-1.6zm3.4 0c.7 0 1.2.7 1.2 1.6s-.5 1.6-1.2 1.6-1.2-.7-1.2-1.6.5-1.6 1.2-1.6zm-1.7 3.7c.5 0 1 .2 1.4.5.4.3.5.7.3 1l-1.1 1.4c-.3.4-.9.4-1.2 0L10.3 12.8c-.2-.3-.1-.7.3-1 .4-.3.9-.5 1.4-.5z" />
            </svg>
        ),
    },
    {
